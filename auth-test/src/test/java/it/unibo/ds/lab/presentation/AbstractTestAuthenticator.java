...
public abstract class AbstractTestAuthenticator {
    ...
    protected abstract Authenticator createAuthenticator() throws BadContentException, ConflictException;
    ...
    public void testRegisterErrors() {
        ...
        assertThrows(BadContentException.class, () -> authenticator.register(noUser));
        assertThrows(BadContentException.class, () -> authenticator.register(noPassword));
        assertThrows(BadContentException.class, () -> authenticator.register(noEmail));
    }
    ...
    @Test
    public void testAuthorize() throws BadContentException, WrongCredentialsException {
        ...
        assertThrows(BadContentException.class, () -> authenticator.authorize(credentialsOf(noUser)));
        assertThrows(BadContentException.class, () -> authenticator.authorize(credentialsOf(noPassword)));
